...
<body>
        ...
        <div class="login-container">
            <div class="login-card">
                ...
                <div class="login-body">
                    ...
                    <!-- Formulario de Login -->
                    <form action="${pageContext.request.contextPath}/FFERALoginServlet" method="POST" id="fferaLoginForm">
                        ...
                        <div class="captcha-container">
                            ...
                            <div class="row align-items-center mb-2">
                                <div class="col-7">
                                    <img src="${pageContext.request.contextPath}/FFERACaptchaServlet" 
                                         alt="CAPTCHA" 
    ...
    <script>
        ...
        function fferaRefreshCaptcha() {
            ...
            img.src = contextPath + '/FFERACaptchaServlet?t=' + new Date().getTime();
        }
